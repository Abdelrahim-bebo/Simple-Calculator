 ...
 * Author: hp
 *
 * Created on July 1, 2024, 8:06 PM
 */
...
#if ADC_INTERRUPT_FEATURE_FNABLE == INTERRUPT_FEATURE_ENABLE
...
#if TIMER1_INTERRUPT_FEATURE_FNABLE == INTERRUPT_FEATURE_ENABLE
...
#if TIMER2_INTERRUPT_FEATURE_FNABLE == INTERRUPT_FEATURE_ENABLE
...
#if TIMER3_INTERRUPT_FEATURE_FNABLE == INTERRUPT_FEATURE_ENABLE
