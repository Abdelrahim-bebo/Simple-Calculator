...
# 1 "Mcal_layer/GPIO/../std_libiraries.h" 1
# 13 "Mcal_layer/GPIO/../std_libiraries.h"
...
# 13 "Mcal_layer/GPIO/../std_libiraries.h" 2
...
# 14 "Mcal_layer/GPIO/../std_libiraries.h" 2
...
# 14 "Mcal_layer/GPIO/../device_config.h"
...
std_returntype gpio_pin_get_direction_status(const pin_config_t * _pin_config ,direction_t * dic_status){
    std_returntype ret = (std_returntype)0x01;
    if(((void*)0)==_pin_config || dic_status ||_pin_config->pin > 8 -1)
    {
        ret = (std_returntype)0x00 ;
    }
        else{
            *dic_status = ((*tris_reg[_pin_config->port] >> _pin_config->pin) & (uint8)1);
        }

    return ret;
}
# 64 "Mcal_layer/GPIO/hal_gpio.c"
std_returntype gpio_pin_write_logic(const pin_config_t * _pin_config , logic_t logic){
    std_returntype ret = (std_returntype)0x01;
    if(((void*)0)==_pin_config ||_pin_config->pin > 8 -1)
    {
...
std_returntype gpio_pin_read_logic(const pin_config_t * _pin_config , logic_t *logic){
    ...
    if(((void*)0)==_pin_config || ((void*)0) == (logic) ||_pin_config->pin > 8 -1)
    {
        ret = (std_returntype)0x00 ;
            ...
            *logic = ((*port_reg[_pin_config->port] >> _pin_config->pin) & (uint8)1);
        }
...
# 130 "Mcal_layer/GPIO/hal_gpio.c"
std_returntype gpio_port_direction_initialize(port_index_t port ,uint8 direction){
    std_returntype ret = (std_returntype)0x01;
      if( port > 5 -1)
    {
...
# 151 "Mcal_layer/GPIO/hal_gpio.c"
std_returntype gpio_port_get_direction_status(port_index_t port ,uint8 *dic_status){
    std_returntype ret = (std_returntype)0x01;
     if((((void*)0)==dic_status)&&(port > 5 -1))
    {
        ret = (std_returntype)0x00 ;
    }
        else{
...
# 173 "Mcal_layer/GPIO/hal_gpio.c"
std_returntype gpio_port_write_logic(port_index_t port , uint8 logic){
    std_returntype ret = (std_returntype)0x01;
       if( port > 5 -1)
    {
...
# 194 "Mcal_layer/GPIO/hal_gpio.c"
std_returntype gpio_port_read_logic(port_index_t port , uint8 *logic){
    std_returntype ret = (std_returntype)0x01;
