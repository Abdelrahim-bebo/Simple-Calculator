...
# 14 "ECU_layer/LCD/ecu_lcd.h"
# 1 "ECU_layer/LCD/ecu_lcd_cfg.h" 1
# 14 "ECU_layer/LCD/ecu_lcd.h" 2

# 1 "ECU_layer/LCD/../../Mcal_layer/GPIO/hal_gpio.h" 1
# 11 "ECU_layer/LCD/../../Mcal_layer/GPIO/hal_gpio.h"
...
# 11 "ECU_layer/LCD/../../Mcal_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/LCD/../../Mcal_layer/GPIO/../mcal_std_types.h" 1
# 13 "ECU_layer/LCD/../../Mcal_layer/GPIO/../mcal_std_types.h"
# 1 "ECU_layer/LCD/../../Mcal_layer/GPIO/../std_libiraries.h" 1
# 13 "ECU_layer/LCD/../../Mcal_layer/GPIO/../std_libiraries.h"
...
# 13 "ECU_layer/LCD/../../Mcal_layer/GPIO/../std_libiraries.h" 2
...
# 14 "ECU_layer/LCD/../../Mcal_layer/GPIO/../std_libiraries.h" 2
...
# 15 "ECU_layer/LCD/../../Mcal_layer/GPIO/../std_libiraries.h" 2
...
# 23 "ECU_layer/LCD/../../Mcal_layer/GPIO/../mcal_std_types.h"
...
# 14 "ECU_layer/LCD/../../Mcal_layer/GPIO/../device_config.h"
...
# 14 "ECU_layer/LCD/../../Mcal_layer/GPIO/../device_config.h" 2
...
# 38 "ECU_layer/LCD/../../Mcal_layer/GPIO/hal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
std_returntype lcd_4bit_send_custome_char(const lcd_4bit_t *lcd , uint8 row, uint8 column,
       ...
       if(((void*)0)==lcd){
        ...
        {
           ret = lcd_4bit_send_command(lcd, (0x40 +(mem_pos*9)));
...
std_returntype lcd_8bit_send_custome_char(const lcd_8bit_t *lcd , uint8 row, uint8 column,
       ...
       if(((void*)0)==lcd){
        ...
        {
           ret = lcd_8bit_send_command(lcd, (0x40 +(mem_pos*9)));
           for(lcd_counter=0; lcd_counter<=7;++lcd_counter){
...
static std_returntype lcd_8bits_set_cursor(const lcd_8bit_t *lcd , uint8 row , uint8 column){
    ...
    column--;
    switch(row){
        case(1): ret = ret = lcd_8bit_send_command(lcd,0x80 + column);break;
        case(2): ret = ret = lcd_8bit_send_command(lcd,0xC0 + column);break;
        case(3): ret = ret = lcd_8bit_send_command(lcd,0x94 + column);break;
        case(4): ret = ret = lcd_8bit_send_command(lcd,0xD4 + column);break;
        default :;
    }
    return ret;
}
static std_returntype lcd_4bits_set_cursor(const lcd_4bit_t *lcd , uint8 row , uint8 column){
    ...
    column--;
    switch(row){
        case(1): ret = ret = lcd_4bit_send_command(lcd,0x80 + column);break;
        case(2): ret = ret = lcd_4bit_send_command(lcd,0xC0 + column);break;
        case(3): ret = ret = lcd_4bit_send_command(lcd,0x94 + column);break;
        case(4): ret = ret = lcd_4bit_send_command(lcd,0xD4 + column);break;
        default :;
    }
    return ret;
}
